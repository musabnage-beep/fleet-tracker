...
import { getReports, getVehicles } from '../../services/api';
...
export default function AdminDashboard() {
  ...
  const loadData = async () => {
    try {
      ...
      let totalFound = 0, totalUnknown = 0;
...
const styles = StyleSheet.create({
  ...
  welcomeText: { fontSize: 14, fontFamily: 'ExpoArabic-Light' },
  userName: { fontSize: 22, fontFamily: 'ExpoArabic-SemiBold' },
  dateContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  dateText: { fontSize: 13, fontFamily: 'Urbanist', fontWeight: '600' },
  sectionTitle: { fontSize: 18, fontFamily: 'ExpoArabic-SemiBold', marginBottom: 12 },
  statsGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 12,
  ...
  statValue: { fontSize: 28, fontFamily: 'Urbanist', fontWeight: '900' },
  statLabel: { fontSize: 12, fontFamily: 'ExpoArabic-Light', marginTop: 2 },
});
