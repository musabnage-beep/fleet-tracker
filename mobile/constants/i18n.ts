...
export const translations = {
  ar: {
    ...
    success: 'نجح',
    added: 'أضيفت',
    duplicatesSkipped: 'مكررة (تم تخطيها)',
    errors: 'أخطاء',
    importFailed: 'فشل الاستيراد',
    importExcel: 'استيراد من Excel',
    downloadExcel: 'تحميل Excel',
    excelFailed: 'فشل إنشاء ملف Excel',
    ...
    resetDeviceConfirm: 'هل تريد إعادة تعيين جهاز',
    reset: 'إعادة تعيين',
    deviceResetSuccess: 'تم إعادة تعيين الجهاز',
    deviceLocked: 'هذا الحساب مسجل على جهاز آخر. تواصل مع المدير',

    // ANPR
    anprSettings: 'إعدادات التعرف على اللوحات',
    anprStatus: 'حالة الاتصال',
    anprConnected: 'متصل',
    anprNotConfigured: 'غير مُعد',
    anprSetToken: 'إعداد مفتاح API',
    anprUpdateToken: 'تحديث مفتاح API',
    anprTokenLabel: 'مفتاح Plate Recognizer API',
    anprTokenHint: 'احصل على المفتاح من platerecognizer.com',
    anprTokenSaved: 'تم حفظ مفتاح API بنجاح',
  },
  ...
  en: {
    ...
    excelFailed: 'Failed to create Excel file',
    ...
    resetDeviceConfirm: 'Reset device for',
    reset: 'Reset',
    deviceResetSuccess: 'Device reset successfully',
    deviceLocked: 'This account is registered on another device. Contact admin',

    // ANPR
    anprSettings: 'Plate Recognition Settings',
    anprStatus: 'Connection Status',
    anprConnected: 'Connected',
    anprNotConfigured: 'Not Configured',
    anprSetToken: 'Set API Key',
    anprUpdateToken: 'Update API Key',
    anprTokenLabel: 'Plate Recognizer API Key',
    anprTokenHint: 'Get your key from platerecognizer.com',
    anprTokenSaved: 'API key saved successfully',
  },
};
